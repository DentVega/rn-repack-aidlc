...
Apply the standards' coding rules (FlashList, memoization, transform/opacity animations, Re.Pack — never Metro). Use the templates in this plugin's `templates/simple/` as the starting structure.

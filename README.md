...
Changes are tracked in [CHANGELOG.md](CHANGELOG.md) following Keep a Changelog + SemVer. Current version: **1.3.1**. Parked ideas and deferred decisions live in [docs/DEFERRED.md](docs/DEFERRED.md).
